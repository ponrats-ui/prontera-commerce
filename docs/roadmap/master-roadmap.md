...
Sprint 8 adds Promotion & Pricing Engine Foundation:

- Promotion campaigns
- Vouchers
- Customer group pricing tiers
- BEST_DISCOUNT_WINS checkout evaluation
...
Future AI pricing is intentionally deferred until the promotion and pricing foundation is stable, auditable, and governed by Human-in-the-Loop rules.
