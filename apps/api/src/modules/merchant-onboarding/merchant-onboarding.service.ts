...
const onboardingDistricts = [
  {
    ...
    x: 68,
    y: 42,
    theme: StorefrontTheme.TECH_BAZAAR,
  ...
  },
  {
    ...
    x: 34,
    y: 58,
    theme: StorefrontTheme.ARTISAN_LIGHT,
    buildingType: MerchantBuildingType.CLASSIC_SHOP,
  ...
  },
  {
    ...
    x: 22,
    y: 76,
    theme: StorefrontTheme.HARBOR_TRADE,
    buildingType: MerchantBuildingType.MARKET_STALL,
  ...
  },
  {
    ...
    x: 74,
    y: 72,
    theme: StorefrontTheme.WARM_MARKET,
    buildingType: MerchantBuildingType.PREMIUM_HALL,
